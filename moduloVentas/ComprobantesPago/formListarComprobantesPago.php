...
class formListarComprobantesPago extends Pantalla
{
    public function formListarComprobantesPagoShow()
    {
        session_start();
                                    ...
                                    <div class="max-w-full overflow-x-auto">
                                        <div class="row mb-4">
                                            ...
                                            <div class="flex gap-2 mb-4 items-center">
                                                <form action="../moduloVentas/ComprobantesPago/getEnlaceComprobantesPago.php" method="post" class="flex gap-3 mb-4 items-center w-full">
                                                    ...
                                                    <div class="flex items-center gap-2 w-1/6">
                                                        <button name="btnBuscarComprobantesPago" type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200 flex items-center w-full text-center">
                                                ...
                                                <form action="./getVerificarEmitirComprobantePago.php" method="post" class="flex gap-1 mb-4 items-center">
                                                    <div class="flex items-center gap-2 w-full">
                                                        <button name="btnEmitirComprobantePago" type="submit" class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition duration-200 flex items-center w-full text-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
