                                            ...
                                            <div class="flex gap-2 mb-4 items-center">
                                                <form action="./getVerificarEditarProducto.php" method="post" class="flex gap-3 mb-4 items-center w-full">
                                                    ...
                                                    <div class="flex items-center gap-2 w-1/6">
                                                        <button name="btnBuscarProducto" type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200 flex items-center w-full text-center">
                                                            ...
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <div class="flex items-center space-x-3">
                                                                    <form action="#" method="post">
                                                                        <input name="id_producto" value="<?= $usuario['id_producto'] ?>" type="text" hidden>
