...
{
    public function formRegistrarProductoShow($privilegios)
    {
        session_start();
                            ...
                            <div class="grid grid-cols-1">
                                <div class="flex flex-col">
                                    ...
                                    <div class="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-5">
                                        ...
                                        <form action="./getVerificarRegistrarProducto.php" method="post">
                                            <div class="p-6.5">
                                                ...
                                                <button name="btnConfirmarRegistrarProducto" type="submit" class="flex w-full justify-center rounded bg-blue-500 p-3 font-medium text-white hover:bg-opacity-90">
                                                    Confirmar
                                                </button>
                                            </div>
                                        </form>
