...
{
    public function formListarDistribuidoresShow($distribuidoresArray = [])
    {
        session_start();
                                    ...
                                    <div class="max-w-full overflow-x-auto">
                                        <div class="row mb-4">
                                            ...
                                            <div class="flex gap-2 mb-4 items-center">
                                                <form action="./getVerificarEditarDistribuidor.php" method="post" class="flex gap-3 mb-4 items-center w-full">
                                                    <div class="flex items-center gap-2 w-1/2">
                                                        <label for="txtBuscarNombreDistribuidor" class="text-lg font-medium text-gray-700">Nombre del Distribuidor</label>
                                                        <input type="text" id="txtBuscarNombreDistribuidor" name="txtBuscarNombreDistribuidor" placeholder="Distribuidor" class="ml-3 px-4 py-2 border rounded-lg w-full" />
                                                    </div>
                                        ...
                                        <table class="w-full table-auto h-[70vh]">
                                            ...
                                            <tbody>
                                            <?php if (isset($distribuidoresArray)): ?>
                                                    <?php foreach ($distribuidoresArray as $key => $distribuidor): ?>
                                                        <tr>
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                            <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['id_distribuidor']); ?></h5>
                                                            </td>
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['nombre']); ?></h5>
                                                            </td>
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['ruc']); ?></h5>
                                                            </td>   
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['direccion']); ?></h5>
                                                            </td>   
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['correo']); ?></h5>
                                                            </td> 
                                                            </td>   
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['telefono1']); ?></h5>
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['telefono2']); ?></h5>
                                                                <h5 class="font-medium text-black"><?= htmlspecialchars($distribuidor['telefono3']); ?></h5>
                                                            </td>                                                      
                                                            
                                                            <td class="border-b border-[#eee] px-4 py-4 dark:border-strokedark">
                                                                <div class="flex items-center space-x-3">
                                                                    <form action="../Distribuidores/getVerificarEditarDistribuidor.php" method="post">
                                                                        <input name="idDistribuidor" value="<?= $distribuidor['id_distribuidor'] ?>" type="text" hidden>
                                                                        <button name="btnEditarDistribuidor" type="submit" class="hover:text-blue-700">
