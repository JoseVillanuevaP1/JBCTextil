                        ...
                        <?php if (in_array(9, $ids)) { ?>
                            <div>
                                ...
                                <ul class="mb-6 flex flex-col gap-1.5">
                                    <li>
                                        <form action="../moduloUsuario/getUsuario.php" method="post">
                                ...
                                <?php if (in_array(5, $ids)) { ?>
                                    <li>
                                        <form action="#" method="post">
                                            <button type="submit" class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-white hover:text-yellow-300 hover:bg-gray- duration-300 ease-in-out bg-meta-4" href="#">
