...
{
    public function formRegistrarUsuarioShow($privilegios)
    {
        session_start();
                                            ...
                                            <div class="p-6.5">
                                                <div class="mb-5 flex flex-col gap-6 xl:flex-row">
                                                    <div class="w-full xl:w-1/2">
                                                        ...
                                                        <input name="txtUsuario" type="text" placeholder="" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                                    </div>
                                                    ...
                                                    <div class="w-full xl:w-1/2">
                                                        ...
                                                        <input name="txtContrasenia" type="password" placeholder="" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <input name="txtCorreo" type="email" placeholder="" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                                                </div>
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="relative z-20 bg-transparent dark:bg-form-input">
                                                        <select name="intHabilitado" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary" :class="isOptionSelected &amp;&amp; 'text-black dark:text-white'" @change="isOptionSelected = true">
                                                            <option value="1" class="text-body">SI</option>
                                                            <option value="0" class="text-body">NO</option>
                                                        </select>
                                                        ...
                                                        ?>
                                                            ...
                                                            <label for="checkboxLabel<?= $privilegio['id_privilegio']; ?>" class="flex cursor-pointer select-none items-center text-lg font-medium text-black">
                                                                <div class="relative">
                                                                    ...
                                                                    <div class="mr-4 flex h-5 w-5 items-center justify-center rounded-full border border-blue-600">
